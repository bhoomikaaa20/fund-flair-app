...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track your income, expenses, and balance in one clean, secure place." },
      { property: "og:title", content: "Finance Tracker" },
      { property: "og:description", content: "Track your income, expenses, and balance in one clean, secure place." },
